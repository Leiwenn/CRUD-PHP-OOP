...
<body>
    ...
    <section class="container-fluid d-flex bg-white notfound">
        <div class="container mt-5 rounded d-flex bg-white">
            ...
            <div class="bg-white text-dark d-flex flex-column justify-content-center align-item-center rounded">
                <h1 class="mb-5">OUPS ! 404</h1>
                <h2 class="font-weight-normal mb-5">Il semblerait que cette page n'existe pas ...</h2>
                <a class="btn btn-info" role="button" href="index.php">Retour vers le blog</a>
            </div>
        </div>
    </section>
