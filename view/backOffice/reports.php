...
<section class="reports pb-4">
    ...
    <div class="m-3 p-3 shadow rounded bg-light">
        <p><i class="far fa-comment-dots text-warning m-2"></i> Demande de <span class="font-weight-bold"><?= $data['pseudo'] ?></span> le <?= $data['report_date_fr'] ?> à propos d'un commentaire du billet: <span class="font-weight-bold"><?= $data['title'] ?></span></p>
